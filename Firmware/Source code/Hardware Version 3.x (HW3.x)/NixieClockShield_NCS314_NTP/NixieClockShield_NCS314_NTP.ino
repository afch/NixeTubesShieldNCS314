...
#include <TimeLib.h> // copy modified Time library to Arduino libraries folder!
...
TimeChangeRule winterTime = {"CET", Last, Sun, Oct, 3, 60};
TimeChangeRule summerTime = {"CEST", Last, Sun, Mar, 2, 120};
Timezone myTZ(winterTime, summerTime);
