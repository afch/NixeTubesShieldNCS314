...
void doIndication()
{
  ...
  */
  ...
  Var64 = Var64 & ((SymbolArray[digits % 10] | doEditBlink(5) | blankDigit(0)) << 6);
  Var64 = Var64 << 48;
  digits = digits / 10;

  tmpVar64 = (SymbolArray[digits % 10] | doEditBlink(4) | blankDigit(1)) << 6;
  Var64 |= (tmpVar64 << 38);
  digits = digits / 10;

  tmpVar64 = (SymbolArray[digits % 10] | doEditBlink(3) | blankDigit(2)) << 6;
  Var64 |= (tmpVar64 << 28);
  digits = digits / 10;

  tmpVar64 = (SymbolArray[digits % 10] | doEditBlink(2) | blankDigit(3)) << 6;
  Var64 |= (tmpVar64 << 18);
  digits = digits / 10;

  tmpVar64 = (SymbolArray[digits % 10] | doEditBlink(1) | blankDigit(4)) << 6;
  Var64 |= (tmpVar64 << 8);
  digits = digits / 10;

  tmpVar64 = (SymbolArray[digits % 10] | doEditBlink(0) | blankDigit(5)) << 6>>2;
  Var64 |= tmpVar64;
